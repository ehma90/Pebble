    ...
    <div className="bg-[#19144E] py-[100px]">
      <div className="container mx-auto">
        ...
        <div className=" block mt-0 mx-4 md:flex md:justify-center md:gap-x-6 md:mx-0 md:mt-[42px] ">
          ...
          <div className=" my-[32px] w-[392px] md:w-[421px] bg-[#6E57E8] pt-[63px] pb-[37px] px-5">
            <h3 className="font-semibold text-xl md:text-[28px]">Skill Trainings</h3>
          ...
          <div className=" my-[32px] w-[392px] md:w-[421px] bg-[#C5164A] pt-[63px] pb-[37px] px-5">
            <h3 className="font-semibold text-xl md:text-[28px]">Women In Tech</h3>
            <p className="text-xl mt-5">
              A meeting of doers and thinkers who are hungry for development and
              growth. It features startup education, business linkups,
              fundraising, and knowledge sharing.
